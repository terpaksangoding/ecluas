      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('assets') }}/dist/img/user3.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Irman Ramadhan</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{asset('assets') }}/dist/img/user3.jpg" class="img-circle" alt="User Image">

                <p>
                  Irman Ramadhan - Web Developer
