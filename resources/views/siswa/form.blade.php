...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="{{ url('siswa/index') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li >Data Siswa</li>
...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <a href="{{ url('siswa/index') }}" class="btn bg-purple"><i class="fa fa-chevron-left"></i> Kembali </a>
    </div>
    <div class="box-body">
    ...
    <div class="form-group">
     ...
     <div class="col-sm-10">
         <input type="number" name="no_tlp" class="form-control" placeholder="Masukkan Nomor Telp" value="{{ @$result->no_tlp }}" >
       </div>
     </div>
     ...
     <div class="form-group">
       ...
       <div class="col-sm-10">
         <select name="id_kelas" class="from-control">
